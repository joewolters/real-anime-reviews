...
import { consentGateDecision, showConsentModal, showSuspendedModal, ensureConsent } from './consent.js?v=2.0.0';
...
import { initLantern, openLanternCenter, markAllNotifsRead } from './lantern.js?v=2.0.0';
