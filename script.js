...
import { consentGateDecision, showConsentModal, showSuspendedModal, ensureConsent } from './consent.js?v=2.0.1';
...
import { initLantern, openLanternCenter, markAllNotifsRead } from './lantern.js?v=2.0.1';
