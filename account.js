...
import { initLantern } from './lantern.js?v=2.3.4';
...
import { ensureConsent, peekConsent } from './consent.js?v=2.3.4';
import { openCropper } from './cropper.js?v=2.3.4';   // round 4 — frame-it crop/reposition (item 2)
...
import { initWrapped } from './wrapped.js?v=2.3.4';
