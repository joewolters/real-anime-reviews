...
import { initLantern } from './lantern.js?v=2.0.1';
...
import { ensureConsent, peekConsent } from './consent.js?v=2.0.1';
import { openCropper } from './cropper.js?v=2.0.1';   // round 4 — frame-it crop/reposition (item 2)
// v1.10.1 hotfix — the ONE branded-error module (no raw SDK strings in UI, ever)
import { friendlyError, showNotice } from './friendly-errors.js?v=2.0.1';
// mega-run C3 — Constellation Wrapped (the member's year as a star map; lazy)
import { initWrapped } from './wrapped.js?v=2.0.1';
// mega-run milestone D — the ONE nav-drawer implementation (shared with script.js)
import { initNavDrawer } from './nav-drawer.js?v=2.0.1';
