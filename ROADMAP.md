...
## ⚡ READ-FIRST
- **Live at v1.9.0** ("Community Overhaul", shipped 2026-06-08). **The next ship is v2.0.0 — Mobile compatibility overhaul** (see `docs/NEXT.md` for the backlog; one known carry-over: review-targeted notification deep-links don't always scroll-to-highlight yet).
