...
| **v1.8.3** (MINOR) ← **next** | **Website Identity & Finalization update** — scroll-reveal lines, first-visit welcome message, anime characters visible on the page, card touch-ups, plus further identity features to be brainstormed at its gate 0 ("make it feel like a real website" — Blake) |
