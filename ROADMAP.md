...
| **v1.8.0** (MINOR) ★ | **Smoothness Overhaul** — blur de-stacking (stacked full-viewport backdrop-filters = #1 diagnosed lag cause), filter→compositor hovers, render-on-navigate caching, esbuild minify (script.js measured 242KB) + image right-sizing, perf-regression guard |
