...
| **v1.8.1** (MINOR) | Admin edit page (`/admin/edit/<slug>`: tags/platforms/watched-set/description) + clickable admin live-preview + Playwright Mode-1 test |
| **v1.8.2** (MINOR) | Structured review template (Intro/Animation/Story/Characters/Design/Music/Feel/Extra Thoughts/Overall; `##`-heading authoring + "Insert template" + jump-pill render) |
