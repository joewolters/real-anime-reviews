...
&nbsp; - Typical fields: uid + createdAt + \_\_name\_\_ (Firebase auto-suggests exact combo)
...
<meta property="og:site\_name" content="Real Anime Reviews" />
...
Fixed Website link and description (Looks good)


v1.2.0 (Minor Update)

Added Random button (dice icon) that opens a truly random anime modal
Added dice hover flip animation
Upgraded header button styling (premium hover/glow/shimmer)
Upgraded search bar styling to match the new button theme
Fixed shimmer “vertical line” artifact across buttons/search
Improved header hover background with a smooth fade overlay (no harsh black line)

v1.3.0 (Minor Update)

Added an “Anime by Genre” shuffle control to refresh the displayed genres
Added previous/next arrows for the Top 10 section so users can browse instantly instead of waiting for the auto-scroll
Upgraded search bar styling to match the new button theme
Implemented various bug fixes and stability improvements across the site
Redesigned the “My Top 10” section for a more premium look and better visual hierarchy
Added an “Anime by Genre” shuffle control to refresh the displayed genres without reloading the page

v1.3.1 (Minor Update)
Added new anime card
...
v1.4.0 (MINOR)
Suggestion box + admin-only viewer
...
Change the font of the website to something that feels more anime. 
...
Add something big to the main page!
